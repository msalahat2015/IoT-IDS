...
class RandomForest(BaseAlgorithm):
    ...
    def __init__(self, params=None):
        ...
        if "replacement" in params:
            self.model = BalancedRandomForestClassifier(**self.params) # Initialize the RandomForestClassifier model
        else :
            self.model = RandomForestClassifier(**self.params) # Initialize the RandomForestClassifier model
    def train(self, X, y):
        """
        Trains the model.
        ...
        """
        self.model.fit(X, y)  # Train the RandomForestClassifier model
